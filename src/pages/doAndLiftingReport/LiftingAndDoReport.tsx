  ...
  return (
    <div className="w-full flex flex-col gap-2 font-sans text-slate-800 p-1 bg-white min-h-screen box-border shadow-none">
      ...
      <div className="report-parameter-box p-3 rounded-xl shadow-sm w-full flex flex-col gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-10 items-end gap-1 w-full bg-transparent ">
          <CommonDateRange
            fromDate={fromDate}
            toDate={toDate}
      ...
      max-h-[425px] w-full box-border">
        ...
        {!showSpinner && showReport && reportData.length > 0 && (
          <div className="w-full overflow-auto max-h-[420px]">
            <table id="lifting-and-do-report-table" className="w-full text-left border-separate border-spacing-0">
              <thead>
                <tr className="h-9 text-[10px] font-bold uppercase whitespace-nowrap">
                  {/* <th className="p-1 px-2 table-header">Channel Type</th>
                  <th className="p-1 px-2 table-header">Channel Id</th> */}
                  <th rowSpan={2} className="p-1 px-2 table-header sticky top-0 z-30">
                    Channel Name
                  </th>
                  ...
                  <th colSpan={5} className="p-1 px-2 bg-teal-200 text-slate-900 font-bold text-center sticky top-0 z-30">
                    {reportHeader?.monthlyDateRange}
                  </th>

                  <th colSpan={5} className="p-1 px-2 bg-emerald-200 text-slate-900 font-bold text-center sticky top-0 z-30">
                    {reportHeader?.dailyDateRange}
                  </th>
                </tr>
                <tr className="text-[10px] font-bold uppercase whitespace-nowrap">
                  <th className="p-1 px-2 bg-purple-100 text-slate-900 font-bold sticky top-9 z-20">Consumer</th>
                  <th className="p-1 px-2 bg-purple-100 text-slate-900 font-bold sticky top-9 z-20">Bulk</th>  
                  <th className="p-1 px-2 bg-purple-100 text-slate-900 font-bold sticky top-9 z-20">Corporate</th>
                  <th className="p-1 px-2 bg-purple-100 text-slate-900 font-bold sticky top-9 z-20">Commodity Trading</th>
                  <th className="p-1 px-2 bg-purple-100 text-slate-900 font-bold sticky top-9 z-20">Monthly Total</th>

                  <th className="p-1 px-2 bg-fuchsia-200 text-slate-900 font-bold sticky top-9 z-20">Consumer</th>
                  <th className="p-1 px-2 bg-fuchsia-200 text-slate-900 font-bold sticky top-9 z-20">Bulk</th>
                  <th className="p-1 px-2 bg-fuchsia-200 text-slate-900 font-bold sticky top-9 z-20">Corporate</th>
                  <th className="p-1 px-2 bg-fuchsia-200 text-slate-900 font-bold sticky top-9 z-20">Commodity Trading</th>
                  <th className="p-1 px-2 bg-fuchsia-200 text-slate-900 font-bold sticky top-9 z-20">Daily Total</th>
                </tr>
              </thead> 
